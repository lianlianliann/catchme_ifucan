...
export function MainMenuScreen({ onStartGame }: MainMenuScreenProps) {
  ...
  useEffect(() => {
    // Play background menu music at 50% volume
    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 border-b border-[#1D9E75] border-opacity-30 py-3 px-6 flex items-center justify-between z-10">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[#1D9E75] text-xs tracking-[2px] opacity-50">
            SYS.READY
          </span>
        </div>
        <span className="text-[#1D9E75] text-xs tracking-[1px] opacity-50">
      ...
      >
        <div className="text-[#5DCAA5] text-sm tracking-[12px] mb-4 opacity-70">
          HOST DEFENSE SYSTEM
        </div>
        <h1 className="text-8xl font-bold text-[#e8f5f0] mb-2 tracking-tight">
          CATCH ME
        </h1>
        <h1 className="text-8xl font-bold text-[#e8f5f0] mb-6 tracking-tight">
          IF YOU CAN
        </h1>
        <div className="text-[#5DCAA5] text-base tracking-[4px] opacity-60">
      ...
      >
        ...
        >
          <span className="text-[#1D9E75] group-hover:text-[#050d0a] text-sm tracking-[8px] font-bold transition-colors">
            DEPLOY
          </span>
        ...
        >
          <span className="text-[#3d6b55] group-hover:text-[#050d0a] group-hover:font-bold text-sm tracking-[6px] transition-colors">
            SETTINGS
          </span>
        </motion.button>
      </motion.div>
      ...
      <div className="absolute bottom-0 left-0 right-0 border-t border-[#1D9E75] border-opacity-30 py-3 px-6 flex items-center justify-between z-10">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[#1D9E75] text-xs tracking-[4px] opacity-50">
            SYS.READY
          </span>
        </div>
        <span className="text-[#1D9E75] text-xs tracking-[2px] opacity-50">

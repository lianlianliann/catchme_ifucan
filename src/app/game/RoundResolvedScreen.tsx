        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-8 space-y-6">
            ...
            <div className="bg-[#0a1f12] border border-[#3d6b55] p-4 rounded-sm">
              <div className="text-[#7F77DD] text-xs tracking-[2px] mb-2">
                SYSTEM ASSESSMENT
              </div>
              <div
                className={`text-sm font-bold ${state.severityIndex > 75 ? "text-[#E24B4A]" : "text-[#5DCAA5]"}`}
              >
                    ...
                    const barColor =
                      ds.score >= 70
                        ...
                        : ds.score >= 40
                          ...
                          : "#E24B4A";
                    const label =
                      DEFENSE_DISPLAY_NAMES[ds.defenseType] ?? ds.defenseType;
                    return (
                      <div key={ds.defenseType}>
                        <div className="flex items-center justify-between mb-1">
                          <div className="text-[#e8f5f0] text-xs tracking-[1px]">
                            {label}
                          </div>
                          <div
                        ...
                        {ds.mutationPenalty && (
                          <div
                            className="text-[10px] tracking-[0.5px] mt-1"
                            style={{
                              color: ds.score < 50 ? "#E24B4A" : "#EF9F27",
                            }}
                          >
                            ⚑ {ds.mutationPenalty}
                          </div>
            ...
            {showTips && tip && (
              ...
              >
                <div
                  className={`text-xs tracking-[2px] mb-2 font-bold ${
                    tip.category === "critical_severity"
                      ? "text-[#E24B4A]"
                      : tip.category === "good_play"
                        ? "text-[#1D9E75]"
